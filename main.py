...
class Game:
    ...
    def awake(self):
        ...
        file = open("C:/Users/saiku/Downloads/snakeAi-master/snakeAi-master/par_lev.json", 'r')
    ...
    def train(self, n, m, pars):
        ...
        while True:
            ...
            if done:
                ...
                self.save_to_file(f"C:/Users/saiku/Downloads/snakeAi-master/snakeAi-master/graphs/{pars.get('graph', 'test')}.txt", agent.n_games, score, record)    
